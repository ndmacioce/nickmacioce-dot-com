    ...
    <div className="mt-32 full-width-container bg-secondary">
      <div className="container max-w-screen-xl mx-auto pt-16 text-gray-900">
        ...
        <p className="px-4 mt-1 text-center text-secondary">
          ...
          <ExtLink link="https://github.com/ndmacioce" newTab>
            GitHub
          </ExtLink>
          ,{" "}
          <ExtLink link="https://twitter.com/ndmacioce" newTab>
            Twitter
          </ExtLink>
          ,{" "}
          <ExtLink link="https://www.instagram.com/ndmacioce/" newTab>
            Instagram
          </ExtLink>
        </p>
        <div className="mx-auto  pt-10 flex justify-center">
          <Button width="widest" link="mailto:ndmacioce@gmail.com">
