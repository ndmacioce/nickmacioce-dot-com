    ...
    <Layout activePage="about">
      ...
      <div className="container">
        <article className="prose">
          <h2>About Me</h2>
          <p>
            I'm Nick Macioce, I work full-time as a game programmer at{" "}
		  ...
		  <p>
		  	This site has been modified from the orginal, found at <a href='https://github.com/jeffjadulco/jeffjadulco.com'>this git repo</a>.
			</p>
        </article>
      </div>
      <Contact />
